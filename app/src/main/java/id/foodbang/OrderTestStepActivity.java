...
import id.foodbang.adapter.OrderTestStepAdapter;
...
public class OrderTestStepActivity extends AppCompatActivity {
    ...
    @BindView(R.id.list_orderteststep)
    ...
    public void onCreate(@Nullable Bundle savedInstanceState, @Nullable PersistableBundle persistentState) {
        ...
        this.setContentView(R.layout.activity_ordertest_step);
        ...
        final OrderTestStepAdapter orderStepAdapter = new OrderTestStepAdapter(this, this.list_items);
