...
public class FpRequestStep extends OrderStep
{
    public FpRequestStep(Context context)
    {
        super(context);
    }
    ...
    protected void initialize(Context context)
    {
        ...
        final View view = LayoutInflater.from(context).inflate(R.layout.step_order_fprequest, this, true);
