...
public class DpApproveStep extends OrderStep
{
    public DpApproveStep(Context context)
    {
        super(context);
    }
    ...
    protected void initialize(Context context)
    {
        ...
        final View view = LayoutInflater.from(context).inflate(R.layout.step_order_dpapprove, this, true);
