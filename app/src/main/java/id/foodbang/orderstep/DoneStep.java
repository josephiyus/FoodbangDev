...
public class DoneStep extends OrderStep
{
    public DoneStep(Context context)
    {
        super(context);
    }
    ...
    protected void initialize(Context context)
    {
        ...
        final View view = LayoutInflater.from(context).inflate(R.layout.step_order_done, this, true);
